        ...
        <div className="nav-bar-admin">
            ...
            <div className="user-info">
                <div className="user-info-container">
                    ...
                    <p style={{opacity: 0.8, fontSize: '14px'}} className='user-role'>Biên tập<span> - {user.editorCategory}</span></p>
                </div>
                <div className="log-out">
                    <FontAwesomeIcon className="icon" onClick={() => onLogout()} icon={faRightFromBracket} />
                </div>
            </div>
        </div>
    );
