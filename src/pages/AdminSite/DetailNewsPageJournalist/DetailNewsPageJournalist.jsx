        ...
        <div className='detail-news-page-journalist'>
            ...
            <div className='news-content'>
                ...
                <div className='news-body'>
                    ...
                    {/*
                        Nếu chưa gửi thì có chỉnh sửa và gửi biên tập
                        Không thì không có nút nào cả 
                    */}
                    <div className='btn-container'>
                        <div className='btn' onClick={() => navigate('/admin/journalist/edit-news/1')}>Chỉnh sửa</div>
                        <div className='btn'>Gửi biên tập</div>
                    </div>
                </div>
            </div>
        </div>
