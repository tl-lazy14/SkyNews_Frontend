...
const ArticleManagementPage = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
    }, [currentPage, filter, searchQuery, selectedDate]);

    return (
        <div className='article-management-page'>
            <div className='top-container'>
                <div><h2 className="name-page">Quản lý tin tức - <span style={{ color: '#312fb5' }}>Thể thao</span></h2></div>
            ...
            <div className='list-articles-container'>
                <div className='article-item'>
                    ...
                    <div className='content-article'>
                        ...
                        <div className='posted-timestamp'>Đã đăng lúc {getFormattedTimestampComment(new Date())}</div>
                        <div className='detail-status'>
                            <div className='btn delete'>
                                <div>Xóa tin</div>
                                <div><FontAwesomeIcon style={{fontSize: '18px'}} icon={faTrashCan} /></div>
                            </div>
                            <div onClick={() => navigate('/admin/editor/list-articles/news/1')} className='btn view-detail-btn'>Xem chi tiết</div>
                            <div className='btn accept'>Đã đăng</div>
                        </div>
                    </div>
                </div>
                <div className='article-item'>
                    ...
                    <div className='content-article'>
                        ...
                        <div className='date-news'>{getFormattedDateMonthYear(new Date())}</div>
                        <div className='declined-timestamp'>Đã từ chối lúc {getFormattedTimestampComment(new Date())}</div>
                        <div className='detail-status'>
                            <div className='btn view-detail-btn'>Xem chi tiết</div>
                            <div className='btn decline'>Đã từ chối</div>
                        </div>
                    </div>
                </div>
                <div className='article-item'>
